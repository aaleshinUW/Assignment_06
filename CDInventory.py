...
class DataProcessor:
    ...
    @staticmethod
    def delete_CD(lstTbl):
        """Deletes CD from in memory table
        
        Args:
            lstTbl (list of dict): In memory 2D data structure (list of dicts) that holds the data during runtime
    ...
    def add_CD(lstTbl, strID, strTitle, strArtist):
        ...
        Args:
            ...
            strID (String): String containing CD ID.
            strTitle (String): String containing CD Title.
            strArtist (String): String containing CD Artist.
...
class FileProcessor:
    ...
    @staticmethod
    def write_file(file_name, lstTbl):
        # TODone Add code here
        """Function to manage writing data from table to file
        
        Writes data from 2D table (list of dicts) to file one row at a time.
...
class IO:
    ...
    @staticmethod  
    def get_Artist():
        """Gets user input for CD Artist.
        
        Args:
            None.
            
        Returns:
            Returns the CD Artist as a string.
        """
...
while True:
    ...
    # 3.3 process add a CD
        ...
        strID = IO.get_ID()
        strTitle = IO.get_Title()
        strArtist = IO.get_Artist()
